...
export default async function ReviewsPage({
  ...
  const stats: ReviewStat[] = [
    { kind: "rating", label: "Average Rating", value: Math.round(currentAvg * 10) / 10, deltaPct: Math.abs(ratingDiff), direction: ratingDiff >= 0 ? "up" : "down", fromLabel: "from last month" },
    { kind: "delta", label: "Total Reviews", value: String(total), deltaPct: totalDelta.pct, direction: totalDelta.direction, fromLabel: "from last month", iconTheme: "blue" },
    { kind: "ratio", label: "5 Star Reviews", value: String(fiveStar), subtitle: pct(fiveStar), iconTheme: "green" },
    { kind: "ratio", label: "4 Star Reviews", value: String(fourStar), subtitle: pct(fourStar), iconTheme: "blue" },
    { kind: "ratio", label: "3 Star & Below", value: String(threeAndBelow), subtitle: pct(threeAndBelow), iconTheme: "red" },
  ];
